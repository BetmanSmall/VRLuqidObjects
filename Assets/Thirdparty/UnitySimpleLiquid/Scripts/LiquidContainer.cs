using Thirdparty.UnitySimpleLiquid.Scripts.Utils;
using UnityEngine;
...
namespace Thirdparty.UnitySimpleLiquid.Scripts
{
    ...
    public class LiquidContainer : MonoBehaviour
    {
        ...
        [SerializeField] [Tooltip("Material prefab (will replace material on mesh renderer)")]
        private Material liquidMaterial;
        [Header("Container settings")] [SerializeField]
        private GameObject cap;
        [SerializeField] [Tooltip("Is container open and can split?")]
        private bool isOpen = true;
        [Header("Liquid settings")] [Tooltip("Smaller inertness - less still liquid")]
        public float inertness = 50;
        [SerializeField] private Color liquidColor = Color.green;
        [Range(0f, 1f)] [SerializeField] private float fillAmountPercent = 0.5f;
        [Header("Container Volume")] [SerializeField]
        ...
        {
            get { return fillAmountPercent * volume; }
            set
            {
        ...
        {
            get { return FillAmountPercent * (maxFillAmount - minFillAmount) + minFillAmount; }
        }
